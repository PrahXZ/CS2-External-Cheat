...
void Cheats::Menu()
{
	...
	ImGui::Begin("Menu - CS2 External Cheat by vPrah",nullptr,ImGuiWindowFlags_AlwaysAutoResize);
	{
		...
		{
			// NoSmoke
			Gui.MyCheckBox("NoSmoke", &MenuConfig::NoSmoke);
			// AntiFlashBang
		...
		ImGui::Text("[HOME] Hide the menu");

		ImGui::Separator();

		ImGui::Text("Red Trust factor modules: BunnyHop and AntiFlashbang");
